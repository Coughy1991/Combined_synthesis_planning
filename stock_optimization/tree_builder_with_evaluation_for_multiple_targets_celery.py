...
#     pickle.dump(Tree, ET)
chem_dict = Tree.Chemical
rxn_dict = Tree.Reaction

pprint.pprint(chem_dict)
pprint.pprint(rxn_dict)
...
dataset['score'] = all_routes_score
dataset = dataset.assign(**dataset_context)
print(dataset.head())

dataset.to_csv(results_folder+'chemical_table_of_all_routes_with_score_and_context.csv')
